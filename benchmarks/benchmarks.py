...
def example_benchmark(num_runs: int = 3):
    ...
    cluster = (
        ...
        .client(2, "us-east1-c", requests=workload[2])
        .client(3, "us-east1-c", requests=workload[3])
...
def build_clock_benchmark_cluster():
    ...
    return (
        ...
        .initial_leader(5)
        .server(1, "europe-north1-b")
        .server(2, "europe-north2-b")
        .server(3, "europe-west1-b")
        .server(4, "europe-west2-b")
        .server(5, "europe-central2-a")
        .client(1, "europe-north1-b", requests=workload[1])
        .client(2, "europe-north2-b", requests=workload[2])
        .client(3, "europe-west1-b", requests=workload[3])
        .client(4, "europe-west2-b", requests=workload[4])
        .client(5, "europe-central2-a", requests=workload[5])
    ).build()
